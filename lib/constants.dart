...
TextStyle heading1=GoogleFonts.roboto(fontSize: 30,color:Colors.black,fontWeight: FontWeight.bold);
TextStyle heading2=GoogleFonts.almarai(fontSize: 20,fontWeight:FontWeight.w700);
TextStyle heading2Green=GoogleFonts.almarai(fontSize: 20,color:green1,fontWeight:FontWeight.w700);
